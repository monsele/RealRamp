...
const MyAssetPage: FunctionComponent = () => {
 ...
 if (isLoading) {
  ...
  return (
    <div className="w-full min-h-screen relative bg-gray-100 overflow-hidden flex flex-col items-start justify-start gap-[325px] leading-[normal] tracking-[normal] text-left text-5xl font-outfit lg:h-auto lg:gap-[162px] mq450:gap-[41px] mq750:gap-[81px]">
      <Toaster />
