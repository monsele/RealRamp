...
import TitleLocation from "../components/PropertyField";

const PublishProperty: FunctionComponent = () => {
  return (
    <div className="w-full h-[1024px] relative bg-gray-100 overflow-hidden flex flex-col items-start justify-start pt-[39px] px-[149px] pb-[132px] box-border gap-[616px] leading-[normal] tracking-[normal] mq800:gap-[154px] mq800:pl-5 mq800:pr-5 mq800:box-border mq1125:gap-[308px] mq1125:pl-[74px] mq1125:pr-[74px] mq1125:box-border mq1350:h-auto">
      <main className="self-stretch flex flex-row items-start justify-start py-0 px-[29px] box-border max-w-full shrink-0">
        <section className="flex-1 flex flex-col items-end justify-start gap-[27px] shrink-0 max-w-full text-center text-5xl text-black font-body-labels">
          <PublishNavBar />
          <div className="self-stretch flex flex-row items-start justify-start gap-[36px] max-w-full mq1125:gap-[18px] mq1350:flex-wrap">
            <div className="flex-1 flex flex-col items-start justify-start gap-[19px] min-w-[391px] max-w-full mq450:min-w-full">
              <h2 className="m-0 relative text-inherit font-medium font-inherit mq800:text-lgi">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[19px] text-sm text-white-base">
                <div className="self-stretch h-80 flex flex-col items-center justify-center">
                  <div className="self-stretch flex-1 flex flex-col items-start justify-start relative gap-[10px]">
                    ...
                    />
                    <div className="w-[186px] !m-[0] absolute top-[84px] left-[216px] [backdrop-filter:blur(16px)] rounded-[7px] bg-darkslategray-400 overflow-hidden flex flex-col items-center justify-start py-[19px] px-[17px] box-border gap-[6px] z-[1]">
                ...
                <div className="self-stretch flex flex-row items-start justify-center gap-[4px] mq450:flex-wrap">
                  <img
            ...
            <div className="w-[438px] flex flex-col items-start justify-start pt-0.5 px-0 pb-0 box-border min-w-[438px] max-w-full text-left text-sm text-gray-300 mq450:min-w-full mq1350:flex-1">
              <div className="self-stretch shadow-[2px_4px_30px_#e9eefd] rounded-3xs bg-white-base flex flex-col items-end justify-start p-4 box-border gap-[12px] max-w-full">
                <div className="mr-[-31px] w-[437px] flex flex-col items-start justify-start pt-0 px-0 pb-[9px] box-border gap-[6px] max-w-[108%] shrink-0 text-center text-5xl text-black">
                  ...
                  <div className="self-stretch relative text-sm text-gray-500 text-left">
                ...
                <TitleLocation
                  ...
                  inputTextFieldPlaceholder="Property name"
                />
                <TitleLocation
                  propertyTitle="Property Location"
                  inputTextFieldPlaceholder="Enter your property location here "
                />
                <div className="self-stretch flex flex-row items-start justify-start gap-[10px] mq800:flex-wrap">
                  <div className="flex-1 flex flex-col items-start justify-start gap-[10px] min-w-[129px]">
                    <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
                      <div className="self-stretch relative font-medium">
                        Property category
                      </div>
                      <div className="self-stretch flex flex-col items-start justify-start relative gap-[10px] text-xs text-gray-200">
                        <div className="self-stretch rounded-3xs bg-dimgray-100 flex flex-row items-center justify-start py-[23px] px-[15px] border-[1px] border-solid border-whitesmoke-200">
                          <div className="relative tracking-[0.01em] inline-block min-w-[61px]">
                            Apartment
                          </div>
                        </div>
                        <img
                    ...
                    <div className="self-stretch rounded-3xs bg-dimgray-100 flex flex-row items-start justify-start py-[23px] px-4 text-xs text-gray-200 border-[1px] border-solid border-whitesmoke-200">
                      <div className="relative tracking-[0.01em] inline-block min-w-[21px]">
                        100
                      </div>
                    </div>
                  </div>
                  <div className="flex-1 flex flex-col items-start justify-start gap-[12px] min-w-[129px]">
                    <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
                      ...
                      <div className="self-stretch flex flex-row items-start justify-start relative text-xs text-gray-200">
                        <div className="flex-1 rounded-3xs bg-dimgray-100 flex flex-row items-start justify-start py-[23px] px-4 border-[1px] border-solid border-whitesmoke-200">
                          <div className="relative tracking-[0.01em] inline-block min-w-[15px]">
                            <input
                ...
                <div className="self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[7px] box-border max-w-full">
                  <div className="flex-1 flex flex-col items-start justify-start max-w-full">
                    <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
                      ...
                      <textarea
                        className="bg-dimgray-100 h-[122px] w-auto [outline:none] self-stretch rounded-3xs box-border flex flex-row items-start justify-start py-4 px-[15px] font-body-labels text-xs text-darkgray border-[1px] border-solid border-whitesmoke-200"
                ...
                <div className="w-[304px] flex flex-row items-start justify-start gap-[19px]">
                  <button className="cursor-pointer py-[7px] px-[18px] bg-[transparent] flex-1 rounded-11xl [background:linear-gradient(180deg,_rgba(58,_150,_173,_0.12),_rgba(90,_130,_252,_0.12))] flex flex-row items-start justify-start whitespace-nowrap border-[2px] border-solid border-black hover:bg-darkslategray-500 hover:box-border hover:border-[2px] hover:border-solid hover:border-darkslategray-200">
                    <div className="relative text-sm font-medium font-body-labels text-gray-1000 text-left inline-block min-w-[98px]">{`Save & sell later`}</div>
                  </button>
                  <button className="cursor-pointer py-[7px] px-[18px] bg-ntblack flex-1 rounded-11xl flex flex-row items-start justify-start whitespace-nowrap border-[2px] border-solid border-base-blue1 hover:bg-darkslategray-100 hover:box-border hover:border-[2px] hover:border-solid hover:border-skyblue">
                    <div className="relative text-base font-body-labels text-white-base text-left inline-block min-w-[107px]">
                      Publish for sale
                    </div>
                  </button>
                </div>
