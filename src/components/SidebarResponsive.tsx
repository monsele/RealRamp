...
const OverviewSidebar: React.FC<OverviewSidebarType> = ({ className = "" }) => {
  ...
  return (
    <>
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-ntblack text-white rounded-md"
      >
      ...
      <div
        className={`
          fixed top-0 left-0 h-full bg-white shadow-xl transition-transform duration-300 ease-in-out
          ${isOpen ? "translate-x-0" : "-translate-x-full"}
          lg:translate-x-0 lg:static lg:h-auto
          flex flex-col items-end justify-start gap-[25px] text-left text-9xl text-black font-outfit
          ${className}
        `}
      >
        <div className="flex flex-row items-start justify-end py-0 px-[37px] w-full">
