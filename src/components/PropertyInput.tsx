  ...
  return (
    ...
    >
      ...
      <div className="self-stretch rounded-3xs bg-dimgray box-border flex flex-row items-start justify-start py-[23px] px-[15px] max-w-full border-[1px] border-solid border-whitesmoke-200">
        <input
          className="w-full [border:none] [outline:none] font-outfit text-xs bg-[transparent] h-[15px] flex-1 relative tracking-[0.01em] text-black text-left flex items-center min-w-[224px] max-w-full p-0"
